        ...
        <Container>
            <Row>
                <Col md={12} style={{marginTop: '2vw', marginBottom:'2vw'}}>
                    <h1 className="text-center">Añadir un nuevo producto</h1>
                </Col>
                <Col md={12}>
                    <Form>
                        <Col md={12} className="d-flex flex-wrap">
                            <FormGroup className="col-md-6">
                                ...
                                <FormControl type="text" name="name" onChange={onChange}/>
                            </FormGroup>
                            <FormGroup className="col-md-6">
                                <FormLabel>Descripción: </FormLabel>
                                <FormControl type="text" name="description" onChange={onChange}/>
                            </FormGroup>
                        </Col>
                        <Col md={12} className="d-flex flex-wrap">
                            <FormGroup className="col-md-3">
                               <FormLabel>SKU:</FormLabel> 
                               <FormControl type="number" name="SKU" onChange={onChange}/>
                            </FormGroup>
                            <FormGroup className="col-md-3">
                            ...
                            <FormGroup className="col-md-3">
                                ...
                                <FormControl type="number" min="0" name="value" onChange={onChange}/>
                            </FormGroup>
                            <FormGroup className="col-md-3">
                        ...
                        <Col md={12}>
                            <FormGroup className="col-md-12">
                                <Button type="button" variant="success" onClick={saveProduct}style={{width: '15%', float: 'right'}}>Guardar</Button>
